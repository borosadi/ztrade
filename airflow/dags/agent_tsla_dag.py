...
def fetch_market_data(**context):
    """Task 1: Fetch current market data for TSLA and save to database."""
...
dag = DAG(
    ...
    description='TSLA momentum trading agent - 5-minute cycles',
    schedule_interval=f'*/{INTERVAL_MINUTES} 14-20 * * 1-5',  # Every 5 min, 9 AM-4 PM EST (14-21 UTC), Mon-Fri
    start_date=days_ago(1),
    catchup=False,
    max_active_runs=1,
    tags=['trading', 'tsla', 'momentum', 'algorithmic'],
)
